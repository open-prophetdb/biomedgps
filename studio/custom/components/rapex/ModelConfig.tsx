...
const ModelConfig: React.FC = (props) => {
    ...
    const [models, setModels] = useState<ModelItem[]>([{
        ...
        icon: <BugOutlined />,
        description: 'To find TopK similar diseases, compounds or targets with a given disease',
        parameters: [{
            key: 'prediction_type',
            ...
            options: [
                ...
                { label: 'Predicted Compounds', value: 'Compound' },
        ...
        },
        {
            ...
            name: 'Disease Name',
            type: 'NodeIdSearcher',
            description: 'Enter a name of disease for which you want to find similar diseases, compounds or targets. If you find multiple items, you might need to select the most relevant one.',
            required: true,
            entityType: 'Disease'
        },
        // {
    ...
    {
        shortName: 'Compound',
        name: 'Prediction for Compound',
        icon: <AimOutlined />,
        description: 'To predict similar compounds, indications or targets for a given drug',
        parameters: [{
            key: 'prediction_type',
            name: 'Prediction Type',
            type: 'select',
            description: 'Select a type for predicting the result, e.g. SimilarDrug is for predicting similar compounds for a given drug.',
            required: true,
            options: [
                { label: 'Similar Compounds', value: 'Compound' },
        ...
        },
        {
            ...
            name: 'Compound Name',
            type: 'NodeIdSearcher',
            description: 'Enter a name of drug for which you want to find similar compounds, indications or targets. If you find multiple items, you might need to select the most relevant one.',
            required: true,
            entityType: 'Compound'
        },
        // {
        ...
        handler: (param: any) => {
            ...
            return new Promise((resolve, reject) => {
                fetchPredictedNodes(params).then((data) => {
                    console.log('Compounds: ', params, data);
                    resolve({
                        params,
                        data
                    });
                }).catch((error) => {
                    console.log('Compounds Error: ', error);
                    reject({ nodes: [], edges: [], error: error })
                });
            });
        }
    },
    {
        ...
        icon: <ZoomInOutlined />,
        description: 'To predict compounds/diseases for a given gene/protein',
        parameters: [{
            key: 'prediction_type',
            name: 'Prediction Type',
            type: 'select',
            description: 'Select a type for predicting the result, e.g. PredictedDrugs is for predicting compounds for a given gene.',
            required: true,
            options: [
                { label: 'Predicted Compounds', value: 'Compound' },
        ...
        },
        {
            ...
            type: 'NodeIdSearcher',
            description: 'Enter a name of gene for which you want to find compounds/diseases. If you find multiple items, you might need to select the most relevant one.',
            required: true,
            entityType: 'Gene'
        },
        {
    ...
    },
    {
        ...
        description: 'To predict compounds for a given group of symptoms',
        parameters: [{
            key: 'prediction_type',
            name: 'Prediction Type',
            type: 'select',
        ...
        },
        {
            ...
            name: 'Symptom Name',
            type: 'NodeIdSearcher',
            description: 'Enter a name of symptom for which you want to find similar compounds. If you find multiple items, you might need to select the most relevant one or select multiple items.',
            required: true,
            entityType: 'Symptom',
            allowMultiple: true
        },
    ...
    const getDefaultRelationType = (entityType: string, predictionType: string) => {
        const DefaultRelationTypeMap: Record<string, string> = {
            'Disease:Disease': 'BioMedGPS::SimilarWith::Disease:Disease',
            'Compound:Compound': 'BioMedGPS::SimilarWith::Compound:Compound',
            'Disease:Compound': 'BioMedGPS::Treatment::Compound:Disease',
            'Disease:Gene': 'BioMedGPS::Causer::Gene:Disease',
            'Compound:Disease': 'BioMedGPS::Treatment::Compound:Disease',
            'Compound:Gene': 'BioMedGPS::Target::Gene:Compound',
            'Gene:Compound': 'BioMedGPS::Target::Gene:Compound',
            'Gene:Disease': 'BioMedGPS::Causer::Gene:Disease',
            // TODO: the relation type is non-standard
            'Symptom:Disease': 'BioMedGPS::Present::Disease:Symptom',
            'Symptom:Compound': 'BioMedGPS::Treatment::Compound:Symptom',
            'Symptom:Gene': 'BioMedGPS::Causer::Gene:Symptom',
        };
