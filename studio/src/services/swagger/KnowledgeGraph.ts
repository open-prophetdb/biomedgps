...
/** Call `/api/v1/curation-statistics` to fetch curation statistics with caching. GET /api/v1/curation-statistics */
export async function fetchCurationStatistics(options?: { [key: string]: any }) {
  return request<swagger.CurationStatistics>('/api/v1/curation-statistics', {
    method: 'GET',
    ...(options || {}),
  });
}
